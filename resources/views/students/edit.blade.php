        ...
        <form method="post" action="/students/{{$students->id}}">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nama"value="{{$students->nim}}" placeholder="Masukkan Nim" name="nim">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('jurusan') is-invalid @enderror" id="nama" value="{{$students->jurusan}}"placeholder="Masukkan Jurusan" name="jurusan">
